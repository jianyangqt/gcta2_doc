...
Although the online version of [GCTA power calculator](cnsgenomics.shinyapps.io/gctaPower/) is available, I think it would still be useful for some users to have the R functions below.
