...
fastGWA is an extremely resource-efficient tool for mixed linear model (MLM)-based GWAS analysis of biobank-scale data such as the UK Biobank (see Jiang et al. [2019 bioRxiv](https://www.biorxiv.org/content/10.1101/598110v1) for details of the method). Credits: [Longda Jiang](mailto:longda.jiang@uq.edu.au) (method, simulation and analysis), [Zhili Zheng](mailto:zhili.zheng@uq.edu.au) (software and analysis) and [Jian Yang](http://researchers.uq.edu.au/researcher/2713) (method and overseeing).

We have applied fastGWA to 3,613 traits on 456,422 array-genotyped and imputed individuals and 2,090 traits on 46,191 whole-exome-sequenced (WES) individuals in the UK Biobank. **All the summary statistics are available at [UKBiobankGWASresults](#DataResource)**.
