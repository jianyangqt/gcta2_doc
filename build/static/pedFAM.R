...
#'        It should contains: "FID", "IID", and a "relationship" columns. The "relationship" column should contain
...
setting_labels = c("MZtwin", "parentOffspring", "fullSib", "second", "third")
...
rel[rel$relationship == "MZtwin", "coef"] <- 1
rel[rel$relationship == "parentOffspring", "coef"] <- 0.5
rel[rel$relationship == "fullSib", "coef"] <- 0.5
rel[rel$relationship == "second", "coef"] <- 0.25
rel[rel$relationship == "third", "coef"] <- 0.125
